# CUC–Ledger Pilot Studies 001–020
...
| Study | Topic |
|---:|---|
| 001 | Consciousness models under CUC |
| 002 | Current AI as consciousness candidate |
| 003 | Threshold requirements for AI candidacy |
| 004 | Embodiment requirement |
| 005 | Digital causal body without robot body |
| 006 | Minimum viable architecture |
| 007 | Falsification suite |
| 008 | Seven-domain benchmark matrix |
| 009 | Applying the benchmark to agent classes |
| 010 | The Habitat environment |
| 011 | Scoring protocol for The Habitat |
| 012 | Habitat-Agent Alpha |
| 013 | Alpha to Beta: autobiographical memory |
| 014 | Alpha vs Beta head-to-head |
| 015 | Beta vs Gamma: workspace integration |
| 016 | Gamma vs Delta: metacognitive calibration |
| 017 | Delta vs Epsilon: intrinsic priority generation |
| 018 | Epsilon vs Zeta: other-agent modeling |
| 019 | Zeta vs Omega: recursive modeling depth |
| 020 | Omega vs Field-Coherent Agent: field coherence level |
